  ...
  return (
    <>
      ...
      <button
        ...
        className="clip-corner fixed bottom-24 md:bottom-8 right-6 md:right-8 z-40 flex items-center gap-2 border border-cyan/60 bg-cyan/20 px-5 py-3 text-sm font-semibold uppercase tracking-wider text-cyan shadow-[0_0_28px_-4px] shadow-cyan/50 backdrop-blur-sm transition-colors hover:bg-cyan/30"
      >
