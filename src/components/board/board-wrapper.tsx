  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-4 md:bottom-8 md:right-8 z-40 flex items-center gap-2 rounded-lg border border-brass/40 bg-primary px-4 py-2.5 font-display text-sm font-bold text-primary-foreground shadow-2xl shadow-brass/20 hover:bg-primary/90 transition-all duration-200 hover:scale-105 active:scale-95"
      >
