  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-8 pr-16">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-display text-xl font-bold text-foreground tracking-wide">Quản lý Mốc Cày</h1>
          <p className="text-xs text-muted-foreground">Thêm, sửa, xóa các mốc Level & Giá tiền cố định</p>
        </div>
      </div>
